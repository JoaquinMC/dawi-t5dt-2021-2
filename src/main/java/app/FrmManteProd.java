...
public class FrmManteProd extends JFrame {
	...
	void listado() {
		...
		for (Producto p : lstProductos) {
			txtSalida.append(p.getId_prod()+ " " + p.getDes_prod() + " " + p.getPre_prod() + "\n");
		}
		txtSalida.append("-------------------------------");
	...
	void llenaCombo() {			
		List<Categoria> listCat = em.createQuery("Select c from Categoria c",Categoria.class).getResultList();	
